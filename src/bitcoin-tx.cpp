...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s qanoncoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  qanoncoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded qanoncoin transaction") + "\n" +
              "  qanoncoin-tx [options] -create [commands]   " + _("Create hex-encoded qanoncoin transaction") + "\n" +
              "\n";
