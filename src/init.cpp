...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/qanoncoin-project/qanoncoin>";
    const std::string URL_WEBSITE = "<https://qanoncoin.org>";
